                    ...
                    <ul class="vertical-menu">
                        <li>
                            <a href="<?php echo base_url('admin/home');?>">
                              <img src="<?php echo base_url();?>assets/admin/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Dashboard</span></i>
                            </a>
                        </li>
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/ecommerce.svg" class="img-fluid" alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/basic.svg" class="img-fluid" alt="basic"><span>Basic UI</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/advanced.svg" class="img-fluid" alt="advanced"><span>Advanced UI</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">                                
                        ...
                        <li>
                            <a href="javaScript:void();">
                              <img src="<?php echo base_url();?>assets/admin/images/svg-icon/apps.svg" class="img-fluid" alt="apps"><span>Apps</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/form_elements.svg" class="img-fluid" alt="form_elements"><span>Forms</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/chart.svg" class="img-fluid" alt="chart"><span>Charts</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/icons.svg" class="img-fluid" alt="icons"><span>Icons</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/tables.svg" class="img-fluid" alt="tables"><span>Tables</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/maps.svg" class="img-fluid" alt="maps"><span>Maps</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="widgets.html">
                                <img src="<?php echo base_url();?>assets/admin/images/svg-icon/widgets.svg" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-success pull-right">New</span>
                            </a>
                        </li>                        
                        <li>
                            <a href="javaScript:void();">
                              <img src="<?php echo base_url();?>assets/admin/images/svg-icon/pages.svg" class="img-fluid" alt="pages"><span>Pages</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                                <li>
