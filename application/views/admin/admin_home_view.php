                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-xl-5 text-center">                                                
                                                <img src="<?php echo base_url();?>assets/admin/images/ecommerce/storage.png" class="img-fluid" alt="storage">
                                    ...
                                    <div class="card-body">
                                        <div class="best-product-slider">
                                            <div class="best-product-slider-item">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <img src="<?php echo base_url();?>assets/admin/images/ecommerce/produc_slider_01.png" class="img-fluid" alt="product">
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="best-product-slider-item">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <img src="<?php echo base_url();?>assets/admin/images/ecommerce/produc_slider_02.png" class="img-fluid" alt="product">
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="best-product-slider-item">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <img src="<?php echo base_url();?>assets/admin/images/ecommerce/produc_slider_03.png" class="img-fluid" alt="product">
                                                    </div>
                                                    <div class="col-8">
