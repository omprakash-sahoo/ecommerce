                    ...
                    <div class="col-md-8 col-lg-8">
                        ...
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo  base_url('admin/home/addCategory'); ?>">Add Category</a></li>
                            </ol>
                        </div>
                    </div>
                </div>          
                        ...
                        <?php echo form_open(); ?>
                            ...
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    <input type="text" class="form-control" name="cat_name" id="inputText" placeholder="Category Name">
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    <input type="text" class="form-control" name="cat_desc" id="inputText" placeholder="Category Description">
                                </div>
